 ...
 * @group Utils
 */
declare function computeHmac(message: string, applicationKey: string, hmacKey: string): string;
...
declare class Stroke implements TStroke {
    ...
    length: number;
    style: TPenStyle;
    constructor(style: TPenStyle, pointerId: number, pointerType?: string, type?: string);
}
/**
 * @group Model
 */
declare function convertStrokeToJSON(stroke: TStroke): TStrokeJSON;
 ...
 * @group Model/Canvas
 */
type TCanvasShapeTableLineSymbol = TSymbol & {
    p1: TPoint;
    p2: TPoint;
};
/**
 ...
 * @group Model/Canvas
 */
type TTextUnderlineSymbol = TTextSymbol & {
...
declare class WSRecognizer {
    ...
    addStrokes(strokes: TStroke[]): Promise<TExport>;
    ...
    resize(model: Model): Promise<Model>;
    importPointEvents(strokes: TStroke[]): Promise<TExport>;
...
declare class CanvasRendererText {
    ...
    protected drawUnderline(context2D: CanvasRenderingContext2D, underline: TUnderLineSymbol, label: string, data: TTextDataSymbol): void;
    protected drawText(context2D: CanvasRenderingContext2D, text: TTextSymbol): void;
    protected drawTextLine(context2D: CanvasRenderingContext2D, textUnderline: TTextUnderlineSymbol): void;
    draw(context2D: CanvasRenderingContext2D, symbol: TSymbol): void;
}
...
export { CanvasRenderer, CanvasRendererShape, CanvasRendererStroke, CanvasRendererText, Configuration, DefaultConfiguration, DefaultConvertionConfiguration, DefaultDebugConfiguration, DefaultDiagramConfiguration, DefaultDiagramConvertConfiguration, DefaultEraserConfiguration, DefaultExportConfiguration, DefaultGrabberConfiguration, DefaultGuidesConfiguration, DefaultJiixConfiguration, DefaultListenerConfiguration, DefaultLoggerConfiguration, DefaultMarginConfiguration, DefaultMathConfiguration, DefaultMathUndoRedoConfiguration, DefaultPenStyle, DefaultRawContentConfiguration, DefaultRawContentRecognitionConfiguration, DefaultRecognitionConfiguration, DefaultRecognitionRendererConfiguration, DefaultRenderingConfiguration, DefaultServerConfiguration, DefaultSmartGuidesConfiguration, DefaultSolverConfiguration, DefaultTextConfiguration, DefaultTextGuidesConfiguration, DefaultTheme, DefaultTriggerConfiguration, DefaultUndoRedoConfiguration, DeferredPromise, Editor, Error$1 as Error, EventType, ExportType, type HTMLEditorElement, type IBehaviors, type IGrabber, type IModel, Intention, InternalEvent, InternalEventType, Logger, LoggerClass, LoggerLevel, LoggerManager, Model, type PartialDeep, PointerEventGrabber, PublicEvent, RestBehaviors, RestRecognizer, SVGStroker, SmartGuide, Stroke, StyleHelper, StyleManager, type TAngleUnit, type TBehaviorOptions, type TBoundingBox, type TBoxLimit, type TCanvasShapeEllipseSymbol, type TCanvasShapeLineSymbol, type TCanvasShapeTableLineSymbol, type TCanvasShapeTableSymbol, type TConfiguration, type TConverstionState, type TConvertionConfiguration, type TDiagramConfiguration, type TDiagramConvertConfiguration, type TEraserConfiguration, type TExport, type TExportConfiguration, type TGrabberConfiguration, type TGuidesConfiguration, type TImageConfiguration, type TImageViewportConfiguration, type TJIIXBase, type TJIIXChar, type TJIIXEdgeElement, type TJIIXEdgeLine, type TJIIXElement, type TJIIXExport, type TJIIXNodeCircle, type TJIIXNodeElement, type TJIIXNodeEllipse, type TJIIXNodeParrallelogram, type TJIIXNodePolygon, type TJIIXNodeRectangle, type TJIIXNodeRhombus, type TJIIXNodeTriangle, type TJIIXStrokeItem, type TJIIXTextElement, type TJIIXWord, type TJiixConfiguration, type TListenerConfiguration, type TLoggerConfiguration, type TMarginConfiguration, type TMathConfiguration, type TMathMLExport, type TMathMLFlavor, type TMathUndoRedoConfiguration, type TPenStyle, type TPoint, type TPointer, type TProtocol, type TRawContentConfiguration, type TRawContentRecognitionConfiguration, type TRecognitionConfiguration, type TRecognitionPositions, type TRecognitionRendererConfiguration, type TRecognitionRendererDebugConfiguration, type TRecognitionType, type TRenderingConfiguration, type TRestPostConfiguration, type TRestPostData, type TRoundingMode, type TSchene, type TServerConfiguration, type TSmartGuidesConfiguration, type TSolverConfiguration, type TSolverOptions, type TStroke, type TStrokeGroup, type TStrokeGroupJSON, type TStrokeJSON, type TSymbol, type TTextConfConfiguration, type TTextConfiguration, type TTextDataSymbol, type TTextGuidesConfiguration, type TTextSymbol, type TTextUnderlineSymbol, type TTheme, type TThemeMath, type TThemeMathSolved, type TThemeText, type TTriggerConfiguration, type TUnderLineSymbol, type TUndoRedoConfiguration, type TUndoRedoContext, type TUndoRedoMode, type TUpdatePatch, type TUpdatePatchAppendChild, type TUpdatePatchInsertBefore, type TUpdatePatchRemoveAttribut, type TUpdatePatchRemoveChild, type TUpdatePatchRemoveElement, type TUpdatePatchReplaceAll, type TUpdatePatchReplaceELement, type TUpdatePatchSetAttribut, type TUpdatePatchType, type TWSMessageEvent, type TWSMessageEventContentChange, type TWSMessageEventContentPackageDescriptionMessage, type TWSMessageEventError, type TWSMessageEventExport, type TWSMessageEventHMACChallenge, type TWSMessageEventPartChange, type TWSMessageEventSVGPatch, UndoRedoContext, UndoRedoManager, WSBehaviors, WSRecognizer, WSSVGRenderer, computeAngleAxeRadian, computeDistance, computeHmac, computeLinksPointers, computeMiddlePointer, convertMillimeterToPixel, convertPixelToMillimeter, convertStrokeToJSON, createUUID, getAvailableFontList, getAvailableLanguageList, isVersionSuperiorOrEqual, mergeDeep };

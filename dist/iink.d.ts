 ...
 * @group Renderer
 */
declare const IISVGRendererConst: {
 ...
 * @group Renderer
 */
declare class IISVGRendererDecoratorUtil {
 ...
 * @group Renderer
 */
declare class IISVGRendererEdgeUtil {
 ...
 * @group Renderer
 */
declare class IISVGRendererEraserUtil {
 ...
 * @group Renderer
 */
declare class IISVGRendererGroupUtil {
 ...
 * @group Renderer
 */
declare class IISVGRendererTextUtil {
 ...
 * @group Renderer
 */
declare class IISVGRendererShapeUtil {
 ...
 * @group Renderer
 */
declare class IISVGRendererStrokeUtil {
 ...
 * @group Renderer
 */
declare class IISVGRendererRecognizedUtil {
...
declare class RecognizerHTTPV2 {
    ...
    protected post(data: unknown, mimeType: string): Promise<unknown>;
    protected tryFetch(data: TRecognizerHTTPV2PostData, mimeType: string): Promise<TExport | never>;
    protected getMimeTypes(requestedMimeTypes?: string[]): string[];
...
export { AbstractEditor, Box, CanvasRenderer, CanvasRendererShape, CanvasRendererStroke, CanvasRendererText, DecoratorKind, DefaulRecognitionHTTPV1ConfigurationConfiguration, DefaultConvertionConfiguration, DefaultDebugConfiguration, DefaultDiagramConfiguration, DefaultDiagramConvertConfiguration, DefaultEditorTriggerConfiguration, DefaultEraserConfiguration, DefaultExportConfiguration, DefaultGestureConfiguration, DefaultGrabberConfiguration, DefaultGuidesConfiguration, DefaultHistoryConfiguration, DefaultIIRendererConfiguration, DefaultInkEditorConfiguration, DefaultInkEditorDeprecatedConfiguration, DefaultInteractiveInkEditorConfiguration, DefaultInteractiveInkSSREditorConfiguration, DefaultJiixConfiguration, DefaultListenerConfiguration, DefaultLoggerConfiguration, DefaultMarginConfiguration, DefaultMathConfiguration, DefaultMathUndoRedoConfiguration, DefaultMenuConfiguration, DefaultPenStyle, DefaultRawContentConfiguration, DefaultRecognitionRendererConfiguration, DefaultRecognitionWebSocketConfiguration, DefaultRecognizerHTTPV1Configuration, DefaultRecognizerHTTPV2Configuration, DefaultRecognizerHTTPV2RecognitionConfiguration, DefaultRecognizerWebSocketConfiguration, DefaultRecognizerWebSocketSSRConfiguration, DefaultRecognizerWebSocketSSRRecognitionConfiguration, DefaultRendererConfiguration, DefaultServerHTTPConfiguration, DefaultServerWebsocketConfiguration, DefaultShapeBeautificationConfiguration, DefaultShapeConfiguration, DefaultShapeConvertConfiguration, DefaultSnapConfiguration, DefaultSolverConfiguration, DefaultStyle, DefaultTexConfigurationV2, DefaultTextConfiguration, DefaultTextGuidesConfiguration, DefaultTextGuidesConfigurationV2, DefaultTheme, DeferredPromise, EdgeDecoration, EdgeKind, Editor, EditorEvent, EditorEventName, EditorLayer, type EditorLayerUI, type EditorLayerUIInfoModal, type EditorLayerUIMessage, type EditorLayerUIState, type EditorOptionsBase, EditorTool, type EditorType, EditorWriteTool, ExportType, HistoryManager, IIConversionManager, IIDebugSVGManager, IIDecorator, IIEdgeArc, IIEdgeLine, IIEdgePolyLine, IIEraseManager, IIEraser, IIGestureManager, IIHistoryManager, IIMenu, IIMenuAction, IIMenuContext, IIMenuManager, IIMenuStyle, IIMenuSub, IIMenuTool, IIModel, IIMoveManager, IIRecognizedArc, IIRecognizedBase, IIRecognizedCircle, IIRecognizedEllipse, IIRecognizedLine, IIRecognizedPolyLine, IIRecognizedPolygon, IIRecognizedText, IIResizeManager, IIRotationManager, IISVGRenderer, IISVGRendererConst, IISVGRendererDecoratorUtil, IISVGRendererEdgeUtil, IISVGRendererEraserUtil, IISVGRendererGroupUtil, IISVGRendererRecognizedUtil, IISVGRendererShapeUtil, IISVGRendererStrokeUtil, IISVGRendererTextUtil, IISelectionManager, IIShapeCircle, IIShapeEllipse, IIShapePolygon, IISnapManager, IIStroke, IISymbolBase, IISymbolGroup, IIText, IITextManager, IITranslateManager, IIWriteManager, InkEditor, InkEditorConfiguration, InkEditorDeprecated, InkEditorDeprecatedConfiguration, InsertAction, InteractiveInkEditor, InteractiveInkEditorConfiguration, InteractiveInkSSREditor, InteractiveInkSSREditorConfiguration, InteractiveInkSSRSVGRenderer, InteractiveInkSSRSmartGuide, JIIXELementType, JIIXEdgeKind, JIIXNodeKind, Logger, LoggerCategory, LoggerLevel, LoggerManager, MatrixTransform, Model, OIEdgeBase, OIShapeBase, type PartialDeep, PointerEventGrabber, type PointerInfo, RecognizedKind, RecognizerError, RecognizerEvent, RecognizerEventName, RecognizerHTTPV1, RecognizerHTTPV1Configuration, RecognizerHTTPV2, RecognizerHTTPV2Configuration, RecognizerWebSocket, RecognizerWebSocketConfiguration, RecognizerWebSocketSSR, RecognizerWebSocketSSRConfiguration, ResizeDirection, SELECTION_MARGIN, SVGBuilder, SVGStroker, ShapeKind, SnapConfiguration, StrikeThroughAction, Stroke, StyleHelper, StyleManager, SurroundAction, SvgElementRole, SymbolType, type TAngleUnit, type TApiInfos, type TBox, type TCanvasShapeEllipseSymbol, type TCanvasShapeLineSymbol, type TCanvasShapeTableLineSymbol, type TCanvasShapeTableSymbol, type TCanvasTextSymbol, type TCanvasTextUnderlineSymbol, type TCanvasUnderLineSymbol, type TConverstionState, type TConvertionConfiguration, type TDiagramConfiguration, type TDiagramConvertConfiguration, type TEditorConfiguration, type TEditorTriggerConfiguration, type TEraserConfiguration, type TExport, type TExportConfiguration, type TGesture, type TGestureConfiguration, type TGestureType, type TGrabberConfiguration, type TGuidesConfiguration, type THistoryConfiguration, type THistoryContext, type TIIEdge, type TIIHistoryBackendChanges, type TIIHistoryChanges, type TIIHistoryStackItem, type TIIRecognized, type TIIRendererConfiguration, type TIIShape, type TIISymbol, type TIISymbolChar, type TImageConfiguration, type TImageViewportConfiguration, type TInkEditorConfiguration, type TInkEditorDeprecatedConfiguration, type TInkEditorDeprecatedOptions, type TInkEditorOptions, type TInteractiveInkEditorConfiguration, type TInteractiveInkEditorOptions, type TInteractiveInkSSREditorConfiguration, type TInteractiveInkSSREditorOptions, type TInteractiveInkSessionDescriptionMessage, type TJIIXBase, type TJIIXChar, type TJIIXEdgeArc, type TJIIXEdgeElement, type TJIIXEdgeElementBase, type TJIIXEdgeLine, type TJIIXEdgePolyEdge, type TJIIXElement, type TJIIXElementBase, type TJIIXExport, type TJIIXLine, type TJIIXNodeCircle, type TJIIXNodeElement, type TJIIXNodeElementBase, type TJIIXNodeEllipse, type TJIIXNodeParrallelogram, type TJIIXNodePolygon, type TJIIXNodeRectangle, type TJIIXNodeRhombus, type TJIIXNodeTriangle, type TJIIXStrokeItem, type TJIIXTextElement, type TJIIXWord, type TJiixConfiguration, type TListenerConfiguration, type TLoggerConfiguration, type TMarginConfiguration, type TMathConfiguration, type TMathMLExport, type TMathMLFlavor, type TMathUndoRedoConfiguration, type TMatrixTransform, type TMenuConfiguration, type TMenuItem, type TMenuItemBoolean, type TMenuItemButton, type TMenuItemButtonList, type TMenuItemColorList, type TMenuItemSelect, type TPenStyle, type TPoint, type TPointer, type TRawContentConfiguration, type TRecognitionHTTPV1Configuration, type TRecognitionPositions, type TRecognitionRendererConfiguration, type TRecognitionRendererDebugConfiguration, type TRecognitionType, type TRecognitionWebSocketConfiguration, type TRecognizerHTTPV1Configuration, type TRecognizerHTTPV1PostConfiguration, type TRecognizerHTTPV1PostData, type TRecognizerHTTPV2Configuration, type TRecognizerHTTPV2PostConfiguration, type TRecognizerHTTPV2PostData, type TRecognizerHTTPV2RecognitionConfiguration, type TRecognizerWebSocketConfiguration, type TRecognizerWebSocketMessage, type TRecognizerWebSocketMessageAuthenticated, type TRecognizerWebSocketMessageContentChange, type TRecognizerWebSocketMessageContextlessGesture, type TRecognizerWebSocketMessageError, type TRecognizerWebSocketMessageExport, type TRecognizerWebSocketMessageGesture, type TRecognizerWebSocketMessageHMACChallenge, type TRecognizerWebSocketMessageIdle, type TRecognizerWebSocketMessageNewPart, type TRecognizerWebSocketMessagePartChange, type TRecognizerWebSocketMessagePong, type TRecognizerWebSocketMessageReceived, TRecognizerWebSocketMessageType, type TRecognizerWebSocketSSRConfiguration, type TRecognizerWebSocketSSRMessage, type TRecognizerWebSocketSSRMessageContentChange, type TRecognizerWebSocketSSRMessageContentPackageDescriptionMessage, type TRecognizerWebSocketSSRMessageError, type TRecognizerWebSocketSSRMessageExport, type TRecognizerWebSocketSSRMessageHMACChallenge, type TRecognizerWebSocketSSRMessagePartChange, type TRecognizerWebSocketSSRMessageSVGPatch, type TRecognizerWebSocketSSRRecognitionConfiguration, type TRendererConfiguration, type TRoundingMode, type TScheme, type TSegment, type TServerHTTPConfiguration, type TServerWebsocketConfiguration, type TShapeBeautificationConfiguration, type TShapeConfiguration, type TShapeConvertConfiguration, type TSnapConfiguration, type TSnapLineInfos, type TSnapNudge, type TSolverConfiguration, type TSolverOptions, type TStroke, type TStrokeGroup, type TStrokeGroupToSend, type TStrokeToSend, type TStyle, type TSubMenuParam, type TSymbol, type TTextConfConfiguration, type TTextConfiguration, type TTextGuidesConfiguration, type TTextGuidesConfigurationV2, type TTextRecognizerHTTPV2ConfConfiguration, type TTextRecognizerHTTPV2Configuration, type TTheme, type TThemeMath, type TThemeMathSolved, type TThemeText, type TUndoRedoMode, type TUpdatePatch, type TUpdatePatchAppendChild, type TUpdatePatchInsertBefore, type TUpdatePatchRemoveAttribut, type TUpdatePatchRemoveChild, type TUpdatePatchRemoveElement, type TUpdatePatchReplaceAll, type TUpdatePatchReplaceELement, type TUpdatePatchSetAttribut, type TUpdatePatchType, computeAngleAxeRadian, computeAngleRadian, computeAverage, computeDistance, computeDistanceBetweenPointAndSegment, computeHmac, computeLinksPointers, computeMiddlePointer, computeNearestPointOnSegment, computePointOnEllipse, computeRotatedPoint, convertBoundingBoxMillimeterToPixel, convertDegreeToRadian, convertMillimeterToPixel, convertPartialStrokesToOIStrokes, convertPartialStrokesToStrokes, convertPixelToMillimeter, convertRadianToDegree, createPointsOnSegment, createUUID, findIntersectBetweenSegmentAndCircle, findIntersectionBetween2Segment, getApiInfos, getAvailableFontList, getAvailableLanguageList, getClosestPoint, getClosestPoints, getInitialHistoryContext, isBetween, isDeepEqual, isPointInsideBox, isPointInsidePolygon, isValidNumber, isValidPoint, isVersionSuperiorOrEqual, mergeDeep, scalaire };

...
class DragAndDropManager {
  constructor(editor) {
    ...
    __publicField(this, "prevPagePoint", new import_editor.Vec());
  ...
  updateDraggingShapes(point, cb) {
    ...
    editor.run(() => {
      if (this.prevDraggingOverShape?.id === nextDraggingOverShape?.id) {
        if (cursorDidMove && nextDraggingOverShape && (0, import_editor.isShapeId)(nextDraggingOverShape.id) && !editor.inputs.previousPagePoint.equals(editor.inputs.currentPagePoint)) {

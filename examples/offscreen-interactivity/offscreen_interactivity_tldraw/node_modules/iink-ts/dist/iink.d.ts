 ...
 */
declare function getBoundingBox(points: TPoint[]): {
    minX: number;
    minY: number;
    maxX: number;
    maxY: number;
 ...
 */
declare function isPointInPolygon(point: TPoint, polygonPoints: TPoint[]): boolean;
 ...
 */
declare function isGroup(symbol: TSymbol): symbol is IISymbolGroup;
/**
 ...
 */
declare function getSymbolTypeLabel(symbol: TSymbol): string;
 ...
 */
declare function createMenuButton(id: string, innerHTML: string, onClick: () => void, additionalClasses?: string[]): HTMLButtonElement;
/**
 ...
 * @returns The configured button element
 */
declare function createMenuButtonWithText(id: string, textContent: string, onClick: () => void, additionalClasses?: string[]): HTMLButtonElement;

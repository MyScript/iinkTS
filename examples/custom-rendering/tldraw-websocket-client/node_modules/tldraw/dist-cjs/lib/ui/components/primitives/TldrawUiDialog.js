...
function TldrawUiDialogTitle({ className, children, style }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ...
    {
      dir: "ltr",
      className: (0, import_classnames.default)("tlui-dialog__header__title", className),
      style,
      children
    }
  );
...
function TldrawUiDialogCloseButton() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "tlui-dialog__header__close", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_radix_ui.Dialog.DialogClose, { "data-testid": "dialog.close", dir: "ltr", asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
...
function TldrawUiDialogBody({ className, children, style }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: (0, import_classnames.default)("tlui-dialog__body", className), style, tabIndex: 0, children });
}

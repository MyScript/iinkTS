...
test.describe("Raw Content Recognizer Ink", () => {
  test.beforeEach(async ({ page }) => {
    await page.goto("/examples/rest/rest_raw_content_InkRecognizer.html")
    await waitForEditorInit(page)
  })

  test("should have title", async ({ page }) => {
    await expect(page).toHaveTitle("Raw Content Recognizer Ink")
  })

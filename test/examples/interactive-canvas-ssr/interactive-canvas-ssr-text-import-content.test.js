...
test.describe("Interactive Canvas SSR Text Import Content", () => {
  test.beforeEach(async ({ page }) => {
    await page.goto("/examples/interactive-canvas-ssr/interactive_canvas_ssr_text_import_content.html")

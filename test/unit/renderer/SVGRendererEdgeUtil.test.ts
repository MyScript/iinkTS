import { DefaultStyle, EdgeDecoration, EdgeKind, IIEdgeArc, IIEdgeLine, IIEdgePolyLine, SVGRendererConst, SVGRendererEdgeUtil, SymbolType, TPoint, TStyle } from "../../../src/iink"
...
describe("SVGRendererEdgeUtil.ts", () =>
{
  ...
  test("should getSVGPath for line", () =>
  {
    ...
    expect(SVGRendererEdgeUtil.getSVGPath(line)).toEqual("M 1 1 L 11 11")
  })
  ...
  test("should getSVGPath for polyline", () =>
  {
    ...
    expect(SVGRendererEdgeUtil.getSVGPath(line)).toEqual("M 1 1 L 1 1 L 11 11 L 111 111")
  })
  ...
  test("should getSVGPath for arc", () =>
  {
    ...
    expect(SVGRendererEdgeUtil.getSVGPath(arc)).toEqual("M 8.071 36.355 Q 8.071 36.355 5.792 44.884 3.126 49.857 0.287 50.873 -2.495 47.847 -4.993 41.027 -7.005 30.964 -8.369 18.473 -8.975 4.567 -8.771 -9.628 -7.777 -22.962 -6.071 -34.355 -6.071 -34.355")
  })
  ...
  describe("getSVGElement", () =>
  {
    test("should get line with style", () =>
    {
      ...
      const el = SVGRendererEdgeUtil.getSVGElement(line)!
    ...
    test("should get line with startDecoration", () =>
    {
      ...
      expect(el.getAttribute("type")).toEqual(SymbolType.Edge)
      const path = el.querySelector("path")!
      expect(path.getAttribute("marker-start")).toEqual(`url(#${ SVGRendererConst. arrowHeadStartMarker })`)
    })
    test("should get line with endDecoration", () =>
    {
      ...
      expect(el.getAttribute("type")).toEqual(SymbolType.Edge)
      const path = el.querySelector("path")!
      expect(path.getAttribute("marker-end")).toEqual(`url(#${ SVGRendererConst.arrowHeadEndMaker })`)
    })
    ...
    test("should get arc with style", () =>
    {
      ...
      const el = SVGRendererEdgeUtil.getSVGElement(arc)!
